...
# empdata = os.path.join("employee_data1.csv") #for testing data set
empdata = os.path.join("employee_data2.csv") # importing main data set
...
with open(empdata, newline="") as csvfile:
